...
function resetPage(){/* Action initiated on clicking reset button */
		
		var xmlhttp=createAjaxRequest();
		xmlhttp.open("GET","uploadtest.xml",false);
		xmlhttp.send();
...
console.log("resetread: DistributomeXML_Objects: ", DistributomeXML_Objects);
...
console.log("my variable content",DistributomeXML_Objects);
	traverseXML(false, null, DistributomeXML_Objects, distributome.nodes, distributome.edges, distributome.references, distributomeNodes, referenceNodes);
		...
		console.log("resetread: xmlDoc: ", xmlDoc);
		console.log("resetread: nodes: ", distributome.nodes);
		console.log("resetread: edges: ", distributome.edges);
		console.log("resetread: distributomeNodes: ", distributomeNodes);
		console.log("resetread: referenceNodes: ", referenceNodes);
...
function textSearch(){
	...
	//traverseXML(true, null, DistributomeXML_Objects, distributome.nodes, distributome.edges, distributome.references, distributomeNodes, referenceNodes, connectivity);
	vis.render();
}
